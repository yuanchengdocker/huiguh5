    ...
    sure:function(){
        ...
        huiguPost(function(data){
            if(data.code==0){
                ...
                setTimeout(function(){
                    //跳转
                    location.href="../flupComplete/index.html";
                },2000)
            }else{
                setToast3(data.msg);
            }
            ...
            followupQuestionnaireId: optUrlParams("topicId"),
...
var applyToast={
    ...
    sure:function(){
        $(".flup-eject2").hide();
        window.location.href='detail.html?patientEducationId=' + patientEducationId;
    }
}
...
$(document).ready(function() {
    ...
    },huiguPostUrl.getSearchFollowUp,{"followupQuestionnaireId":optUrlParams("topicId"),"ofPatientId":ofPatientId })
})
